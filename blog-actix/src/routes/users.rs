...
fn create_user(
    ...
    pool: web::Data<Pool>, // Diesel is syncronus, so we use web::block to execut a blocking function on a thread pool & returns a future that resolves to teh result of the function execution
